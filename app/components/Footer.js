...
const footerNavigation = {
  about: [
    ...
    { name: "Founder & President", href: "/about/founder" },
    { name: "PBCM Board", href: "/about/board" },
    { name: "Mission & Vision", href: "/about/mission" },
  ],
  equipping: [
    { name: "Equipping", href: "/equipping" },
    { name: "PBCM 2022 Vision", href: "/equipping/pbcm-2022-vision" },
    { name: "Cancer Care Ministry", href: "/equipping/cancer-care" },
    { name: "Titus 2 - Womens Ministry", href: "/equipping/titus-2" },
  ],
  social: [
    {
      name: "Facebook",
      ...
      <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
          <div className="flex space-x-6 md:order-2">
            <Link to="/">
              <img className="w-auto h-24" src={image} alt="" />
            </Link>
          </div>
