...
import chsfountain from "../assets/Pineapple_Fountain.jpeg";
import CSBC_Logo from "../assets/csbc-logo.png";
import JDW_Network from "../assets/JDWLogo-V4.png";
import ACBC_Certified from "../assets/certified-ACBC-badge.png";
import BibleStudy from "../assets/Bible_study.jpeg";
import CovidPic from "../assets/covid-pic.jpeg";
import Award from "../assets/ACBC_Certificate.jpg";
import Anchor from "../assets/Hope_Anchors_Event_Image.jpeg";
import FounderPhoto from "../assets/jdwilson21.jpg";
        ...
        <div className="relative pt-16 pb-32 overflow-hidden">
          ...
          <div className="relative bg-gray-900 mt-24">
            <div className="relative h-56 bg-indigo-600 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
              <img className="w-full h-full object-cover" src={Award} alt="" />
              <div
                aria-hidden="true"
